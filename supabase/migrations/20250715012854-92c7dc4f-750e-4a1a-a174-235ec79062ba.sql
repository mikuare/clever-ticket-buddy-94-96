-- Drop and recreate the function to add escalated tickets count
DROP FUNCTION IF EXISTS public.get_admin_summary_stats_by_date_range(date, date);

-- Recreate function with new return type including escalated tickets count
